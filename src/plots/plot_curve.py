...
print(cwd)
plot_var="n_horizon"
csv_filepath=cwd+"/../logs/testing_curve"#+plot_var+"curve"
...
ax1.plot(df.x, df.y)
ax1.plot(df.x_c[27:], df.y_c[27:], linewidth=12, color=(0,0,0,0.5))
...
fig.suptitle("Behaviour in curve for FTG controller ")
