...
for r in l: #timeout: 5 min (60*5/5)
    ...
    if rosgraph.is_master_online(): # Checks the master uri and results boolean (True or False)
        ...
        os.system("roslaunch f1tenth_mpc full_simulation.launch world_name:={} node_type:=ftg velocity_weight:=2.5 velocity:=6 r_v:=1.0 r_delta:=1.0 n_horizon:=5 log_file_name:={}".format(world, logfile))
