...
cwd=sys.path[0]
print(cwd)
csv_filepath=cwd+"/../logs/horizon_centerline"
...
for r in param_list: #timeout: 5 min (60*5/5)
    ...
    if rosgraph.is_master_online(): # Checks the master uri and results boolean (True or False)
        ...
        os.system("roslaunch f1tenth_mpc full_simulation.launch node_type:=centerline velocity:='7' n_horizon:={} log_file_name:={}".format(r, csv_filepath))
