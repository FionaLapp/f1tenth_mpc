...
cwd=sys.path[0]
print(cwd)
csv_filepath=cwd+"/../logs/v_weight_ftg4"
...
for r in param_list: #timeout: 5 min (60*5/5)
    ...
    if rosgraph.is_master_online(): # Checks the master uri and results boolean (True or False)
        ...
        os.system("roslaunch f1tenth_mpc full_simulation.launch node_type:=ftg velocity:='7' n_horizon:=5  velocity_weight:={} r_v:=1 r_delta:=1 log_file_name:={}".format(r, csv_filepath))
